...
Ansible Kafka repository contains roles, playbooks, and configurations to automate Kafka-related tasks using Ansible.
...
1. Clone this repository:
   ```bash
   git clone https://github.com/tamal-pension/ansible-kafka.git
   cd ansible-api
